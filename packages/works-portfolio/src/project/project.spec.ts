...
import type { IZProject } from "./project.mjs";
import { ZProjectBuilder } from "./project.mjs";
...
describe("ZProjectBuilder", () => {
  ...
  describe("Source", () => {
    it("should set the value", () => {
      const expected = new ZUrlBuilder()
        ...
        .append("works")
        .build();
      expect(createTestTarget().source(expected).build().source).toEqual(
        expected,
      );
    });
  });
  ...
  describe("Kind", () => {
    ...
    it("should set to library", () => {
      expect(createTestTarget().library().build().kind).toEqual(
        ZProjectKind.Library,
      );
    });
    ...
    it("should set to desktop", () => {
      expect(createTestTarget().desktop().build().kind).toEqual(
        ZProjectKind.Desktop,
      );
    });

    it("should set to console", () => {
      expect(createTestTarget().console().build().kind).toEqual(
        ZProjectKind.Console,
      );
    });
  });
  ...
  describe("Technology", () => {
    it("should default to other", () => {
      expect(createTestTarget().build().technology).toEqual(
        ZProjectTechnology.Other,
      );
    });

    it("should set to java", () => {
      expect(createTestTarget().java().build().technology).toEqual(
        ZProjectTechnology.Java,
      );
    });

    it("should set to dotnet", () => {
      expect(createTestTarget().dotnet().build().technology).toEqual(
        ZProjectTechnology.DotNet,
      );
    });

    it("should set to node", () => {
      expect(createTestTarget().node().build().technology).toEqual(
        ZProjectTechnology.Node,
      );
    });
  });
  ...
  describe("Assign", () => {
    it("should assign updated properties", () => {
      ...
      const partial: Partial<IZProject> = {
        name: expected.name,
        kind: expected.kind,
