...
import { fullPath, ZRouteButton } from '../../src/routes';
...
When(
  ...
  async function (this: ZLearnWorld<ZButtonPageComponentModel>, name: 'button' | 'iconButton') {
...
When(
  ...
  async function (
    this: ZLearnWorld<ZButtonPageComponentModel>,
...
When(
  ...
  async function (this: ZLearnWorld<ZButtonPageComponentModel>, fashion: string) {
    const choice = await this.parameters.page.fashion();
    await choice.select(fashion);
  }
);

Then('an alert should be displayed on the button page', async function (this: ZLearnWorld<ZButtonPageComponentModel>) {
...
Then(
  ...
  async function (this: ZLearnWorld<ZButtonPageComponentModel>, name: 'button' | 'iconButton', fashion: string) {
    const button = await this.parameters.page[name]();
