...
When(
  ...
  async function (this: ZLearnWorld<ZChoicePageComponentModel>, name: 'dropdown' | 'autocomplete') {
...
When(
  ...
  async function (this: ZLearnWorld<ZChoicePageComponentModel>, text: string, name: ChoiceDemo) {
    const choice = await this.parameters.page[name]();
...
When(
  ...
  async function (this: ZLearnWorld<ZChoicePageComponentModel>, name: OptionCheckbox) {
...
Then(
  ...
  async function (this: ZLearnWorld<ZChoicePageComponentModel>, values: string) {
...
Then(
  ...
  async function (this: ZLearnWorld<ZChoicePageComponentModel>, name: ChoiceDemo) {
    const choice = await this.parameters.page[name]();
